...
{
    public partial class NWConsole_48_TELContext : DbContext
    {
        public NWConsole_48_TELContext()
        {
        }

        public NWConsole_48_TELContext(DbContextOptions<NWConsole_48_TELContext> options)
            : base(options)
        {
        }
